...
public:
    ...
    inline earth_point(double const& long_degree, double const& long_minute, double const& long_second, double const& lat_degree, double const&  lat_minute, double const& lat_second)
    {
    ...
    /// Get longitude
    inline double const& set_lon() const
    { return this->longitude; }

    // Get latitude
    inline double const& set_lat() const
    ...
    /// Set longitude
    inline void get_lon(double const& v)
    { this->longitude = v; }

    /// Set latitude
    inline void get_lat(double const& v)
    { this->latitude = v; }
